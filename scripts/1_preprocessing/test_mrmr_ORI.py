...
data = [(1.0, [1.0, 1.1, 1.2], [1.0, 1.1], 7.0, 1.5, -2.3), 
        (2.0, [None, None, None], [2.0, 1.9], 7.0, 8.5, 6.7), 
        (2.0, [None, None, None], [3.0, 2.9], 7.0, -2.3, 4.4),
        (3.0, [4.0, 3.9, 4.1], [3.0, 3.1], 7.0, 0.0, 0.0),
        (4.0, [5.0, 4.9, 5.1], [4.0, 3.9], 7.0, 12.1, -5.2)]
